...
export const Training = () => {
  ...
  const ListenMode = () => (
    <Stack gap="md">
      ...
      {currentPhrase && (
        <Paper p="md" radius="lg" style={{ background: "var(--gold-cream)", border: "2px solid var(--gold-light)" }}>
          <Text size="xl" fw={700} c="var(--gold-dark)" mb="xs">
            {currentPhrase.text}
          </Text>
      ...
      {!session ? (
        ...
        <>
          ...
          {!showAnswer ? (
            ...
            <Paper p="md" radius="lg" style={{ background: "var(--gold-cream)", border: "2px solid var(--gold-light)" }}>
              <Text size="sm" c="dimmed" mb="xs">
                Correct: <Text span c="var(--gold-dark)" fw={700}>{currentPhrase.text}</Text>
              </Text>
              {userInput.toUpperCase() !== currentPhrase.text && (
                <Text size="sm" c="dimmed">
                  Your answer: <Text span c="var(--accent-error)" fw={700}>{userInput.toUpperCase()}</Text>
                </Text>
              )}
        ...
        <Paper p="lg" radius="lg" style={{ background: "var(--gold-cream)", border: "2px solid var(--gold-light)", textAlign: "center" }}>
          <Text size="xl" fw={700} c="var(--gold-dark)" mb="xs">
            Session Complete!
          </Text>
    ...
    <Stack gap="md">
      ...
      <Paper p="lg" radius="lg" shadow="sm" style={{ background: "var(--bg-card)", border: "1px solid var(--border-light)" }}>
        ...
        <SegmentedControl
          ...
          fullWidth
          styles={{
            root: { background: "var(--gold-warm)", borderRadius: 12 },
            indicator: { background: "var(--teal-primary)" },
            label: { color: "var(--gold-dark)", fontWeight: 600 },
          }}
        />
        ...
        <Group gap="md" wrap="wrap" mt="md">
          <Box style={{ flex: 1, minWidth: 120 }}>
            ...
            <SegmentedControl
              ...
              styles={{ root: { background: "var(--gold-warm)" } }}
            />
          </Box>
